...
<div class="row g-3">
    ...
    <div class="col-md-4">
        <p>Ijazah</p>
        <img src="/assets/img/<?= $formulir['ijazah']; ?>" alt="" class="rounded w-100" height="350">
    </div>

    <div class="col-md-8">
        <form class="row g-3" method="post" action="/verifikasiformulir/update/<?= $formulir['id_formulir']; ?>" id="form" enctype="multipart/form-data">
            ...
            <div class="col-md-6">
                ...
                <select class="form-select <?= validation_show_error('status') ? 'is-invalid' : ''; ?>" id="status" name="status" required>
                    ...
                    <option value="3" <?= $formulir['status'] == 3 ? 'selected' : ''; ?>>Berkas Formulir Ditolak</option>
